...
import com.voci.app.data.local.database.UpdateStatus
...
import com.voci.app.ui.components.updates.FormText
...
fun onSend(
    ...
    val update = Update(
        ...
        creatorId = volunteerViewModel.currentUser.value?.id.toString(),
        status = updateStatus
    )
